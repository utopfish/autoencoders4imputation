...
class KDNode(Node):
    ...
    def dist(self, point,distanceType='euclidean'):
        """
    ...
    def search_knn(self, point, k, dist=None,distanceType='euclidean'):
        ...
        if dist is None:
            get_dist = lambda n: n.dist(point,distanceType)
        else:
            get_dist = lambda n: dist(n.data, point,distanceType)
    ...
    def _search_node(self, point, k, results,  counter):
        ...
        nodeDist = distance(self.data,point)
