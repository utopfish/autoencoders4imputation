...
@File    : SOTABaselineMIDA.py
@Author  : Mr.Liu Meng
@E-mail  : utopfish@163.com
@Time    : 2020/12/21 17:31
"""
import pandas as pd
import numpy as np
...
@costTime
def imputeMethodMIDA(result,originData,missData,missRate,missPattern,dataType='continuous'):
    imputationMethod = "MIDA"
    try:
