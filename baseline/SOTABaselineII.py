...
@File    : SOTABaselineII.py
@Author  : Mr.Liu Meng
@E-mail  : utopfish@163.com
@Time    : 2020/12/21 17:22
"""
import math
import pandas as pd
import numpy as np
...
@costTime
def imputeMethodII(result,originData,missData,missRate,missPattern,dataType='continuous'):
    imputationMethod = "IterativeImputer"
    try:
